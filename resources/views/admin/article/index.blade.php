    ...
    <table class="table table-hover text-center">
      ...
      @foreach($articles as $article)
        <tr>
          ...
          <td><div class="button-group"> <a class="button border-main" href="{{url('admin/article/'.$article->id.'/edit')}}"><span class="icon-edit"></span> 修改</a> <a class="button border-red" href="javascript:void(0)" onclick="delArticle({{$article->id}})"><span class="icon-trash-o"></span> 删除</a> </div></td>
        </tr
   		@endforeach
...
function delArticle(id){
  ...
  layer.confirm('你确定要删除这个文章??',function(){
      $.ajax({
          type:'delete',
