...
<div class="header bg-main">
  ...
  <div class="head-l"><a class="button button-little bg-green" href="{{url('/')}}" target="_blank"> 前台首页</a> &nbsp;&nbsp; &nbsp;&nbsp;<a class="button button-little bg-red" href="{{url('admin/logout')}}">退出登录</a> </div>
</div>
<div class="leftnav">
