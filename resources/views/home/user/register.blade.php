       ...
       <div class="panel-body"> 
        ...
        {{csrf_field()}}
         ...
         <div class="form-group "> 
          ...
          <input class="form-control" name="username" type="text" value="" ajaxurl="{{url('check')}}" placeholder="请填写2-10用户名" datatype="s2-10" /> 
         </div> 
		 
		 <div class="form-group "> 
          <label class="control-label" for="phone">密码</label> 
          <input class="form-control" name="password" type="text" value="" datatype="s6-12" placeholder="请填写6-12密码" required="" /> 
         </div> 
         <div class="form-group "> 
